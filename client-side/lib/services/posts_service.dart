...
class PostsService {
  ...
  static Future<List<dynamic>> getAllJourneys() async {
    final response = await http.get(Uri.parse('$_baseUrl/Journeys/all'));
  ...
  static Future<Map<String, dynamic>> getJourneyById(int id) async {
    final response = await http.get(Uri.parse('$_baseUrl/Journeys/$id'));
  ...
  static Future<List<dynamic>> getUsersJourneys() async {
    final response = await http.get(Uri.parse('$_baseUrl/Journeys/mine'));
