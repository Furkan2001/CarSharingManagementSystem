...
class _MessagesScreenState extends State<MessagesScreen> {
  ...
  Future<void> _loadEndMessages() async {
    try {
      var endMessages =
          await MessageService.getEndUnreadedMessagesForAPerson(_currentUserId);
      setState(() {
      ...
      body: Container(
        ...
        child: ListView.separated(
          ...
          itemBuilder: (context, index) {
            ...
            final chatPartner =
                isCurrentUserSender ? message['receiver'] : message['sender'];
            ...
            return ListTile(
              title: Text(chatPartner['name'] + ' ' + chatPartner['surname'],
          ...
          separatorBuilder: (context, index) =>
              Divider(color: Colors.white), // Customizing the divider color
